...
struct AppState {
    ...
    action_history: Vec<ActionHistory>,
    is_loading: bool,
...
#[derive(Debug, Clone)]
struct PortStatus {
    db_port_available: bool,
    pgadmin_port_available: bool,
}
